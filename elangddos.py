...
print("\033[95m .----------------.  .----------------.   .----------------.  .----------------.  .----------------.  .----------------. \033[m")
print("\033[95m| .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. |\033[m")
print("\033[95m| |    ______    | || |   ___        | | | |  ______      | || |  ________    | || |     ____     | || |    _______   | |\033[m")
print("\033[95m| |   |  ___|    | || |   |  |       | | | | | |_ ___ `.  | || | |_   ___ `.  | || |   .'    `.   | || |   /  ___  |  | |\033[m")
print("\033[95m| |   | |___     | || |   |  |       | | | |   | |   `. \ | || |   | |   `. \ | || |  /  .--.  \  | || |  |  (__ \_|  | |\033[m")
print("\033[95m| |   |  ___|    | || |   |  |       | | | |   | |    | | | || |   | |    | | | || |  | |    | |  | || |   '.___`-.   | |\033[m")
print("\033[95m| |   | |___     | || |   |  |___    | | | |  _| |___.' / | || |  _| |___.' / | || |  \  `--'  /  | || |  |`\____) |  | |\033[m")
print("\033[95m| |   |_____|    | || |   |______|   | | | | |________.'  | || | |________.'  | || |   `.____.'   | || |  |_______.'  | |\033[m")
print("\033[95m| |              | || |              | | | |              | || |              | || |              | || |              | |\033[m")
print("\033[95m| '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' |\033[m")
print("\033[95m '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------' \033[m")  
