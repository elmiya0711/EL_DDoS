...
print("\033[95m| .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. |\033[0m")
print("\033[95m| |    ______    | || |   ___        | | | |  ______      | || |  ________    | || |     ____     | || |    _______   | |\033[0m")
print("\033[95m| |   |  ___|    | || |   |  |       | | | | | |_ ___ `.  | || | |_   ___ `.  | || |   .'    `.   | || |   /  ___  |  | |\033[0m")
print("\033[95m| |   | |___     | || |   |  |       | | | |   | |   `. \ | || |   | |   `. \ | || |  /  .--.  \  | || |  |  (__ \_|  | |\033[0m")
print("\033[95m| |   |  ___|    | || |   |  |       | | | |   | |    | | | || |   | |    | | | || |  | |    | |  | || |   '.___`-.   | |\033[0m")
print("\033[95m| |   | |___     | || |   |  |___    | | | |  _| |___.' / | || |  _| |___.' / | || |  \  `--'  /  | || |  |`\____) |  | |\033[0m")
print("\033[95m| |   |_____|    | || |   |______|   | | | | |________.'  | || | |________.'  | || |   `.____.'   | || |  |_______.'  | |\033[0m")
print("\033[95m| |              | || |              | | | |              | || |              | || |              | || |              | |\033[0m")
print("\033[95m| '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' |\033[0m")
print("\033[95m '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------' \033[0m")  
			
Script just for testing only
...
def main():
	parser = ArgumentParser(
		...
		epilog='''
Example:
    ./%(prog)s -t www.example.com -p 80 -T 2000 -Pyslow
    ./%(prog)s -t www.domain.com -s 100 -Request
    ./%(prog)s -t www.google.com -Synflood -T 5000 -t 10.0
'''
	)
